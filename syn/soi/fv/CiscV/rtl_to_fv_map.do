...
# Generated on: Tue Dec 17 16:03:54 CET 2024 (Tue Dec 17 15:03:54 UTC 2024)
...
set logfile fv/CiscV/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/CiscV -revised fv_map
...
add_search_path models/liberty -library -both
read_library -liberty -both \
    /home/christopher/Bit-Serial-RISC-V/syn/soi/models/liberty/KISTA_SOI_STDLIB2_CCS_TT.lib
...
read_design -rangeconstraint -configuration  -enumconstraint -golden -lastmod -noelab  -vhdl 93  ../../source/brisc/program_package.vhdl -vhdl 93  ../../source/brisc/CiscV.vhdl
elaborate_design -golden -root {CiscV} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/CiscV/fv_map.v.gz
elaborate_design -revised -root {CiscV}
...
#add_name_alias fv/CiscV/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.CiscV.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.CiscV.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.CiscV.rtl.fv_map.rpt
