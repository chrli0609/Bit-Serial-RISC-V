...
set_db -quiet runtime_by_stage {{PBS_Generic-Start 0 10 0.0 10.0} {to_generic 5 15 5 15} {first_condense 11 27 12 28} {PBS_Generic_Opt-Post 17 27 17.335246 27.335246} {{PBS_Generic-Postgen HBO Optimizations} 0 27 0.0 27.335246} {PBS_TechMap-Start 0 28 0.0 27.335246} {{PBS_TechMap-Premap HBO Optimizations} 0 28 0.0 27.335246} {second_condense 5 33 6 35} {reify 3 36 5 40} {global_incr_map 0 36 1 42} {{PBS_Techmap-Global Mapping} 8 36 8.277972000000002 35.613218} {{PBS_TechMap-Datapath Postmap Operations} 2 38 2.0 37.613218} {{PBS_TechMap-Postmap HBO Optimizations} 0 38 -0.044000000000004036 37.569218} {{PBS_TechMap-Postmap Clock Gating} 0 38 0.0 37.569218} {{PBS_TechMap-Postmap Cleanup} 2 40 1.935060000000007 39.504278000000006} {PBS_Techmap-Post_MBCI 0 40 0.0 39.504278000000006} {incr_opt 67 107 68 114} }
...
set_db -quiet flow_metrics_snapshot_uuid 72243683-1412-4868-af67-d1cc05f09fad
...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name CLK -domain domain_1 -period 9000.0 -divide_period 1 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -remove -design design:serv_synth_wrapper port:serv_synth_wrapper/clk
...
set_db -quiet design:serv_synth_wrapper .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 2069246} {cell_count 1092} {utilization  0.00} {runtime 5 15 5 15} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 2184204} {cell_count 1304} {utilization  0.00} {runtime 11 27 12 28} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 2169291} {cell_count 1292} {utilization  0.00} {runtime 5 33 6 35} }{reify {wns -4284} {tns 377850} {vep 166} {area 1701440} {cell_count 1628} {utilization  0.00} {runtime 3 36 5 40} }{global_incr_map {wns -4226} {tns 376321} {vep 166} {area 1673920} {cell_count 1628} {utilization  0.00} {runtime 0 36 1 42} }{incr_opt {wns -2955} {tns 302872} {vep 163} {area 1688480} {cell_count 1594} {utilization  0.00} {runtime 67 107 68 114} }}
...
set_db -quiet inst:serv_synth_wrapper/g22196__5122 .seq_dup_name_count 1
...
set_db -quiet inst:serv_synth_wrapper/g22298__9945 .seq_dup_name_count 1
...
## Written on 06:53:49 02-Jan 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 72243683-1412-4868-af67-d1cc05f09fad}
